...
number_of_teams = 5  # These values can be changed as long as we adhere to the note above
# These values can be changed as long as we adhere to the note above
total_num_of_people = 50
focus = 1  # 0 corresponds to diversity, 1 corresponds to similarity. In this case we have 0, so diversity is favored
...
# Helper function to convert a list into tuple

...
class Team:
    ...
    def personality_performance(self) -> float:
        ...
        if (self.personality_diversity):
            return (st.mean([extrv_SD, conscience_SD, intellect_SD, agreeableness_SD, emotional_stability_SD]))
        return (-1*st.mean([extrv_SD, conscience_SD, intellect_SD, agreeableness_SD, emotional_stability_SD]))

...
def run(problem, params):
    ...
    # Position means the position of the vector variable (in case of multivariable)
    # or value (in case being a single variable)
    empty_individual.position = None

    # cost is the function value evaluated at a certain position
    empty_individual.cost = None

    # Best Solution ever found
    bestsol = empty_individual.deepcopy()
    # I added multiplier of -1
    bestsol.cost = -1*np.inf
    ...
    for i in range(0, npop):
        ...
        # I flipped the inequalaty in this version
    ...
    for it in range(maxit):
        ...
        for k in range(nc//2):
            ...
            # Select parents randomly here. NOTE: We are not using the probability based Roullette wheel selection!
            ...
            # I flipped the inequality in this version
        ...
        pop = pop + popc
        pop = sorted(pop, reverse=True, key=lambda x: x.cost)
        pop = pop[0:npop]
